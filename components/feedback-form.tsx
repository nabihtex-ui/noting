...
export function FeedbackForm({ user }: { user: SessionUser | null }) {
  ...
  if (!user) {
    return (
      <div className="flex flex-col items-center gap-4 rounded-2xl border border-border/60 bg-card p-8 text-center">
        <p className="text-sm text-muted-foreground">
          سجّل الدخول بالديسكورد عشان تقدر تكتب فيدباك.
        </p>
  ...
  return (
    <form onSubmit={submit} className="flex flex-col gap-4 rounded-2xl border border-border/60 bg-card p-5 sm:p-6">
